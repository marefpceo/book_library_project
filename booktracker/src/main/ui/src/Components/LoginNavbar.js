    ...
    return <div>
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2 5 dark:bg-slate-200">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                <Link to="/dashboard" className="flex self-center text-lg font-semibold whitespace-nowrap dark:text-gray-500">
                    Book Tracker
                </Link>
                ...
                <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        <li>
                            <p className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-300 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-gray-900 dark:hover:bg-gray-700 dark:hover:text-gray-300 md:dark:hover:bg-transparent dark:border-gray-700">Welcome!</p>
                        </li>
                        <li>
