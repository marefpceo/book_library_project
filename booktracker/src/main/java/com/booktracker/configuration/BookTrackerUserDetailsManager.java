...
public class BookTrackerUserDetailsManager implements UserDetailsManager {
	...
	public boolean userExists(String username) {
		UserDimention usr = userDao.getUserInformation(username);
		return Optional.ofNullable(usr).isPresent() && null != usr.getUsername()
				&& usr.getUsername().equalsIgnoreCase(username);
	}
